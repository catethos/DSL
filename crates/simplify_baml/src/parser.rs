...
impl<'a> Parser<'a> {
    ...
    fn coerce_string(value: &JsonValue) -> Result<BamlValue> {
        match value {
    ...
    fn coerce_int(value: &JsonValue) -> Result<BamlValue> {
        match value {
            JsonValue::Number(n) => {
    ...
    fn coerce_float(value: &JsonValue) -> Result<BamlValue> {
        match value {
            JsonValue::Number(n) => {
    ...
    fn coerce_bool(value: &JsonValue) -> Result<BamlValue> {
        match value {
