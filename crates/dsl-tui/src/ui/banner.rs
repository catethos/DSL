...
pub fn get_banner() -> Vec<Line<'static>> {
    vec![
        // ASCII Art Logo - "capyFLOW" with enhanced aesthetic
        Line::from(""),
        ...
        Line::from(vec![
            ...
            Span::styled(":vars, :help, :clear, :q", Style::default().fg(Color::White)),
        ]),
        Line::from(""),
        // Quick Start
        Line::from(vec![Span::styled(
        ...
        Line::from(vec![
            ...
            Span::styled(" or type ", Style::default().fg(Color::White)),
            Span::styled(
                ":q",
                Style::default().fg(Color::Red).add_modifier(Modifier::BOLD),
            ),
...
pub fn get_repl_artwork() -> Vec<Line<'static>> {
    // Aesthetic banner for workspace mode - simpler approach without box
    vec![
        Line::from(""),
        Line::from(vec![
            Span::styled(
...
pub fn get_help_text() -> Vec<String> {
    vec![
        ...
        "  :q       - Quit the REPL (or use Ctrl-C)".to_string(),
        "".to_string(),
        "Syntax:".to_string(),
